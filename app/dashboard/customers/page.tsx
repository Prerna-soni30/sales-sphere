        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow">
            ...
            <table className="w-full">
              <thead className="bg-gray-50 dark:bg-gray-700">
                <tr>
                  ...
                  <th className="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase">Deals</th>
              ...
              <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                {filteredCustomers.map((customer) => (
                  <tr key={customer.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <td className="px-4 py-3 text-center text-sm text-gray-600 dark:text-gray-400">{customer.deals}</td>
                    <td className="px-4 py-3 text-right text-sm font-medium text-gray-900 dark:text-gray-100">{customer.revenue}</td>
          ...
          <div className="block md:hidden">
            <div className="px-4 py-2 border-b border-gray-200 dark:border-gray-700">
              <p className="text-xs font-medium text-gray-500">Customers ({filteredCustomers.length})</p>
            </div>
            <div className="p-4">
              {filteredCustomers.map((customer) => (
                <div key={customer.id} className="mobile-table-row mb-3 last:mb-0">
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
              ...
              <div className="flex flex-col sm:flex-row justify-end gap-2 mt-6">
                ...
                <button onClick={handleAddCustomer} className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 order-1 sm:order-2">Add Customer</button>
              </div>
            </div>
          </div>
        )}
